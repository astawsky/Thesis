...
if __name__ == '__main__':
    ...
    for lin_id in pu.lineage_ID.unique():
        ...
        lineage[phenotypic_variables] = (lineage[phenotypic_variables] - lineage[phenotypic_variables].mean()) / lineage[phenotypic_variables].std()
        lineage[phenotypic_variables] = lineage[phenotypic_variables].cumsum()
        ...
        axes[4].plot(lineage['generation'], lineage['division_ratio'])
        ...
        axes[4].set_ylabel(symbols['physical_units']['division_ratio'])
